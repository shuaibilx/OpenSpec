 ...
 */
export declare const CORE_WORKFLOWS: readonly ["roadmap", "propose", "explore", "apply", "update", "sync", "archive"];
/**
 * All available workflows in the system.
 */
export declare const ALL_WORKFLOWS: readonly ["roadmap", "propose", "explore", "new", "continue", "apply", "update", "ff", "sync", "archive", "bulk-archive", "verify", "onboard"];
