...
export class UpdateCommand {
    ...
    async execute(projectPath) {
        ...
        const shouldRestartIde = affectedToolIds.some((toolId) => {
            ...
            return Boolean(tool?.requiresIdeRestart &&
    ...
    async upgradeLegacyTools(projectPath, detection, canPrompt, desiredWorkflows, delivery) {
        ...
        const inferredCodexWorkflows = getProfileWorkflows('custom', getLegacyWorkflowIdsForTool(detection, 'codex')).filter((workflow) => ALL_WORKFLOWS.includes(workflow));
